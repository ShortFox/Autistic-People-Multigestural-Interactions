namespace MQ.MultiAgent
{
    ...
    public class SyncExperiment : NetworkBehaviour
    {
        ...
        [SyncVar] public int predictiveGaze;
        [SyncVar] public int av_Display;
        [SyncVar] public int gaze_1;
        [SyncVar] public int gaze_2;
        [SyncVar] public int gaze_3;
        [SyncVar] public int gaze_4;
        ...
        private void Start()
        {
            ...
            ExperimentManager.Instance.enabled = true;
        }
        ...
        public void SyncTrialInfo(int number, TrialInfo trial)
        {
            ...
            roleB = trial.RoleB;
            predictiveGaze = trial.PredictiveGaze;
            av_Display = trial.AV_Display;
            gaze_1 = trial.Gaze_1;
            gaze_2 = trial.Gaze_2;
            gaze_3 = trial.Gaze_3;
            gaze_4 = trial.Gaze_4;
